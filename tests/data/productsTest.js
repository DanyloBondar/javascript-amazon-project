...
describe('test suite: Clothing', () => {
  ...
  it('displays a chart link in extraInfoHTML', () => {
    expect(clothing.extraInfoHTML()).toEqual('<a href="images/clothing-size-chart.png" target="_blank">Size Chart</a>');
    console.log(clothing.extraInfoHTML());
...
describe('test suite: Appliance', () => {
  ...
  it('displays warranty and instructions in extraInfoHTML', () => {
